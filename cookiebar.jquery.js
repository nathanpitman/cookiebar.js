$(document).ready(function () {
	...
	if (cb_policy) {
		...
		if (!cb_vis()) {
			...
			var bodyBackgroundPosY = parseInt($("body").css("background-position-y")+29);
