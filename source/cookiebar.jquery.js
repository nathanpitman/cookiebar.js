$(document).ready(function () {
	...
	if (!readCookie('cb_visibility')) {
		...
		$('#cookiebar button').click(function() {
			var expires = 365 * 10;
			document.cookie = "cb_visibility=0"+expires+"; path=/";
			$('#cookiebar').toggle();
		});
